...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cmsplugin_cmsformdefinition', (
        ...
        db.send_create_signal(u'form_designer_form', ['CMSFormDefinition'])


    def backwards(self, orm):
        # Deleting model 'CMSFormDefinition'
        db.delete_table(u'cmsplugin_cmsformdefinition')
    ...
    models = {
        ...
        u'form_designer_form.cmsformdefinition': {
            'Meta': {'object_name': 'CMSFormDefinition', 'db_table': "u'cmsplugin_cmsformdefinition'", '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'form_definition': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['form_designer.FormDefinition']"})
        }
    }

    complete_apps = ['form_designer_form']