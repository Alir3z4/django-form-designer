...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'form_designer_formvalue', (
        ...
        db.send_create_signal(u'form_designer', ['FormValue'])

        # Deleting field 'FormLog.data'
        db.delete_column(u'form_designer_formlog', 'data')

        # Adding field 'FormLog.created_by'
        db.add_column(u'form_designer_formlog', 'created_by',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'form_designer_formvalue')

        # Adding field 'FormLog.data'
        db.add_column(u'form_designer_formlog', 'data',
                      self.gf('picklefield.fields.PickledObjectField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'FormLog.created_by'
        db.delete_column(u'form_designer_formlog', 'created_by_id')
